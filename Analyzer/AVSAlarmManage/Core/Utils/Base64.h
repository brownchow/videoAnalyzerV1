#ifndef AVSALARMMANAGE_BASE64_H
#define AVSALARMMANAGE_BASE64_H
#include <string>
...
namespace AVSAlarmManageLib {
    ...
    static void Base64Encode(unsigned char * data, int size, std::string& out_encoded) {
    ...
    static void Base64Decode(std::string& data, std::string& out_decoded) {
